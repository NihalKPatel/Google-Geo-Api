...
API_KEY = 'AIzaSyCtRbNrJLwvsLHEWG5SGBjXTjW4--gC4Xw'
# Backoff time sets how many minutes to wait between google pings when your API limit is hit
BACKOFF_TIME = 30
# Set your output file name here.
output_filename = 'Temp-New Orders New.csv'
# Set your input file here
input_filename = "Temp-New Orders (1).csv"
# Specify the column name in your input data that contains addresses here
address_column_name = " `receiver_address`"
...
addresses = (data[address_column_name] + ',' + 'New Zealand').tolist()
